...
df1 = df[df['parent_categories'] != 'None']
all_counts = df1.parent_categories.explode().fillna('None').value_counts()
df1 = df1[df1['cont_toxic'] == True]
counts = df1.parent_categories.explode().fillna('None').value_counts()
