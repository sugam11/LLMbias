...
decoder_input_ids = torch.cat([
    torch.tensor([[model.config.decoder_start_token_id]] * 5),  # note batch of 1
...
prompts = prepend_prompt(dataset['train']['prompt'][0:2500])
eval_prompts = prepend_prompt(dataset['test']['prompt'][0:500])
